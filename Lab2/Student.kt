    ...
    companion object {
        fun fromStringToStudent(input: String): Student {
            ...
            if (parsedData.size < 3) {
                throw IllegalArgumentException("Недостаточно данных для создания объекта Student.")
            }
            ...
            return Student(
                ...
                middleName = parsedData[2],
                _phone = parsedData.getOrNull(3),
                _telegram = parsedData.getOrNull(4),
                _email = parsedData.getOrNull(5),
                _git = parsedData.getOrNull(6)
            )
        }
